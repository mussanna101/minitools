...
const DEFAULT_DESC =
  '50+ free online tools for PDF, text, image, calculators, converters, developer & fun tasks. No signup, runs 100% in your browser.';

export default function SEO({
  title = `${SITE_NAME} - 50+ Free Online Tools`,
